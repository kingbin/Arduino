 ...
 *
 */
public class TwitterFriendsTimelinePullService implements PullService {

	private Twitter twitter;
	
	public TwitterFriendsTimelinePullService(String username, String password) throws ParserConfigurationException {
	...
	public IContent execute(Integer serviceId, XBeeResponse response, ServiceContext serviceContext) throws Exception {
		List<Tweet> results = twitter.getFriendsTimeline();
